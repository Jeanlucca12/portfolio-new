...
export const EXPERIENCES = [
  {
    ...
    description: `Experiência: Virtual Private Network (VPN), WSUS, Office 365, Administração de Sistemas, ERP, Microsoft Active Directory`,
    technologies: ["Office365", "MS Active Directory", "SQ Server", "PowerShell"],
  },
  {
    year: "2022 - 2023",
